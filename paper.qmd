...
Data from one police force area for the three calendar years 2021 to 2023 <!-- (N= 18,363 records) --> (N = `r nrow(d_all) |> scales::number(big.mark = ",")` records) is analysed.
...
Hyden’s model demonstrates that the inverse relationship between crash frequency and severity.
