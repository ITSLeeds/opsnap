...
Some records lacked either an offence or a location, leaving `r round(nrow(d) / nrow(d_all) * 100, 1)`% or `r nrow(d)` complete records.
...
Cyclists undertake two percent of road miles in the UK (Department for Transport, 2023b).
